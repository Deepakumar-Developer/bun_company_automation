...
!\[Circuit Image](https://github.com/Deepakumar-Developer/bun\_company\_automation/tree/main/assets/image.jpg)
...
## 6\. Arduino Code (`Arduino\_Control\_Code.ino`)
...
* flutter\_bluetooth\_serial
* permission\_handler (for managing Bluetooth permissions)
